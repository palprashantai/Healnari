...
logo = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 600" role="img" aria-label="HealNari">
  ...
  <text x="600" y="380" font-family="'Playfair Display', Georgia, serif" font-size="280" font-weight="800" letter-spacing="-0.02em" fill="#FFFFFF">Heal</text>
...
with open('d:/femcare/Healnari/public/brand/logo-dark.svg', 'w') as f:
    f.write(logo)
