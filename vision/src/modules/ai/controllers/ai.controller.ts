...
export class AiController {
  ...
  @ApiOperation({
    summary:
      'Generate structured SOAP clinical notes from teleconsultation details',
  })
  async generateSoapNotes(
    ...
    if (
      ...
      throw new ForbiddenException(
        'Only doctors can generate clinical SOAP notes.',
      );
    }
  ...
  @ApiOperation({
    summary:
      'Plain-English lab report analyzer and biomarker decoder with cycle phase calibration',
  })
