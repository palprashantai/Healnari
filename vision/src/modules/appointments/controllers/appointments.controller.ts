...
export class AppointmentsController {
  ...
  @ApiOperation({ summary: "List the caller's appointments (patient: own; doctor: assigned to them)" })
  @Get()
  ...
  @Post()
  async create(@CurrentUser() user: AuthUser, @Body() body: CreateAppointmentDto) {
  ...
  @ApiOperation({ summary: 'Advance the caller (doctor)\'s today queue by one step' })
  @Post('call-next')
