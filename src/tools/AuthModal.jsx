          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                {mode === 'login' && (
                  <a href="#" className="text-xs font-semibold text-aubergine-600 hover:text-aubergine-700">Forgot?</a>
                )}
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3.5 rounded-xl font-bold text-white bg-gradient-to-r from-aubergine-600 to-magenta-600 hover:opacity-95 shadow-md shadow-aubergine-500/20 transition-all mt-4 disabled:opacity-60 active:scale-[0.98]"
            >
