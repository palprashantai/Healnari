        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="flex bg-slate-100 p-1 rounded-xl mb-6 text-center">
            <button
              ...
              className={`flex-1 py-2 text-xs md:text-sm font-bold rounded-lg transition-all flex flex-col sm:flex-row justify-center items-center gap-1 sm:gap-2 ${
                role === 'patient' 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button 
              type="submit"
              className={`w-full py-3.5 rounded-xl font-bold text-white shadow-md transition-all mt-4 ${
                role === 'patient' 
