...
const steps = [
  {
    num: 1,
    title: 'Book Your ₹799 Consultation',
    price: '₹799',
    desc: 'Pick your specialist and book a slot in under 2 minutes. No queue, no forms, no waiting rooms. Our team confirms your booking instantly and sends you a secure video link.',
    bullets: [
      'Choose from Gynaecologist, Endocrinologist, Trichologist & more',
      'Available today — morning, afternoon or evening slots',
      'Book anonymously — no judgment, completely private',
    ],
  ...
  {
    num: 2,
    title: '45-Min Deep-Dive With Your Doctor',
    desc: 'Your specialist actually listens. In a secure, encrypted 45-minute video call, your doctor goes deep into your symptoms, history, and lifestyle to identify the root hormonal cause — not just mask it.',
    bullets: [
      'Full symptom & lifestyle history review (not a 5-min OPD)',
      'Root-cause hormonal diagnostic assessment',
      'Personalised lab-test roadmap & digital prescription',
    ],
    image: '/generated/step2.webp',
    imageAlt: 'Indian female doctor in a video consultation with a patient',
    accent: '#8B7355',
  ...
  },
  {
    ...
    desc: 'Within 24 hours you receive your personalised care plan. Then 14 days of free follow-up chat with your care team to tweak and track — so you\'re never left figuring it out alone.',
    bullets: [
      'Custom diet, sleep & exercise plan for your hormonal profile',
      '14-day free chat follow-up included with every consult',
      'Monthly review calls available to track your progress',
    ],
    image: '/generated/step3.webp',
    imageAlt: 'Happy healthy Indian woman after completing her treatment protocol',
    accent: '#7a3e65',
