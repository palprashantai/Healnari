...
const steps = [
  {
    ...
    price: '₹799',
    desc: 'Select from verified specialists across General Medicine, Dermatology, Endocrinology, Gynaecology, Nutrition, or Movement. Not sure? Use our 1-tap care discovery tool to find the right department.',
    bullets: [
      'Verified General Physicians, Dermatologists, Endocrinologists & Gynaecologists',
      'Non-diagnostic guided matching if you are unsure',
      'Flexible morning, afternoon, and evening video slots',
    ],
    image: '/generated/step1.webp',
    imageAlt: 'Patient choosing a verified specialist on HealNari',
    accent: '#5A7A5A',
    tagBg: 'bg-sage-50 text-sage-800 border-sage-100',
    tag: 'Step 1 · Choose Your Specialist',
  },
  {
    num: 2,
    title: 'Book Your Consultation',
    desc: 'Pick your preferred date and time in seconds with transparent pricing (₹799) and zero hidden clinic fees. Complete a quick, confidential intake so your doctor is prepared before you connect.',
    bullets: [
      'Simple online slot booking with instant confirmation',
      'Pre-visit intake notes reviewed by doctor in advance',
      'Bank-grade encrypted & confidential patient health data',
    ],
    image: '/generated/step2.webp',
    imageAlt: 'Patient booking a telemedicine consultation slot',
    accent: '#8B7355',
    tagBg: 'bg-sand-50 text-sand-600 border-sand-100',
    tag: 'Step 2 · Book Your Consultation',
  },
  {
    num: 3,
    title: 'Meet Your Doctor & Receive Your Care Plan',
    desc: 'Connect in a dedicated 45-minute private video visit where your doctor actually listens. Receive a root-cause diagnosis, lab roadmap, legally valid digital prescription, and 14 days of free chat follow-up.',
    bullets: [
      'Full 45-minute 1-on-1 private video consultation',
      'Official digital prescription & personalized lab roadmap',
      '14-day free follow-up chat support included at no extra charge',
    ],
    image: '/generated/step3.webp',
    imageAlt: 'Doctor providing care plan to patient in consultation',
    accent: '#7a3e65',
    tagBg: 'bg-brand-50 text-brand-700 border-brand-100',
    tag: 'Step 3 · Meet Doctor & Care Plan',
  },
];
